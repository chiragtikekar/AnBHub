<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    $UsernameOrEmail = $_POST["UnameOrEmail"];
    $Password = $_POST["Password"];

    $sql = "SELECT * FROM `signup_page` WHERE `Email Address` LIKE '$UsernameOrEmail' OR `Username` = '$UsernameOrEmail';";
    ...
    if ($num == 1)
    {
      while ($row = mysqli_fetch_assoc($result))
      {
          if ($Password == $row['Password'])
          {
            ...
            $showMessage = "Welcome back " . $UsernameOrEmail;
          }
          else
          {
    ...
    {
      // echo "<script>alert('Incorrect Username or Email Address')</script>";
      $showAlert = "Login Unsuccessful";
      $showError = "Incorrect Username or Email Address";
    }
  }
        ...
        if ($showAlert != "" && $showMessage != "")
        {
          ...
          <div class='notification'>
              <div class='content flex justify-between bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3'>
                  ...
                  <div class='button'>
                      <button class='button-green' role='button'><a href='index.html'>Next</a></button>
                  </div>
              </div>
          </div>";
        }
        if ($showAlert != "" && $showError != "")
        {
          ...
          <div class='notification'>
              <div class='content flex justify-between bg-red-300 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md' role='alert'>
                  ...
                  <div class='button'>
                      <button class='button-red' role='button'><a href='login.php'>Next</a></button>
                  </div>
              </div>
          </div>";
        }
    ...
    <section class="h-screen">
        <div class="px-6 h-full text-gray-800">
          ...
          >
            ...
            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0 border-gray-300 border-2 rounded-lg">
              <form action="" method="POST" class="p-12">
                <div class="flex flex-row items-center justify-center lg:justify-start">
                  <p class="text-lg mb-0 mr-4">Login with</p>
                  <button
                    type="button"
                ...
                <div class="form elements">
                  <div class="mb-6 inputBox">
                      <input name="UnameOrEmail" type="text"
